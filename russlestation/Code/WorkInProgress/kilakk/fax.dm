...
/obj/machinery/faxmachine/attack_hand(mob/user as mob)
	...
	onclose(user, "copier")
	return
/obj/machinery/faxmachine/CanPass(atom/movable/mover, turf/target, height=0, air_group=0)
