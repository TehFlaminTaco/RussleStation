...
//	var/enable_authentication = 0		// goon authentication
	...
	var/forumurl
	var/bugurl
	var/donateurl ="http://www.ss13.us/forums/index.php?topic=699.0"
	...
	var/alert_desc_gamma = "This is Centcom, we have dectected a rogue nuclear warhead that has appeared from a micro-wormhole. It is on its way and will impact the station in 30 seconds, by the time you read this message you are probably already dead, it was nice knowing you..."
	...
	var/vip_legacy_system = 0	//Defines whether the server uses the legacy vip system with vip.txt or the SQL system. Config option in config.txt
