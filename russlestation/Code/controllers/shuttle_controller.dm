		...
		if(alert == 0)
			for(var/area/A in world)
				if(istype(A, /area/hallway))
					A.readyalert()
					for(var/obj/machinery/light/emergency/FL in A)
						if(!FL.on)
							FL.on = 1
							FL.brightness = 2
							FL.update()
							FL.update_icon()
							playsound(A, 'sound/ambience/signal.ogg', 30, 0)
			...
			if(direction == 2)
				...
				/* --- Shuttle has arrived at Centrcal Command --- */
					...
					*/
					...
					start_location = locate(/area/shuttle/escape_pod_medical/transit)
					end_location = locate(/area/shuttle/escape_pod_medical/centcom)
					start_location.move_contents_to(end_location, null, NORTH)
					...
					start_location = locate(/area/shuttle/arrival/transit)
					end_location = locate(/area/shuttle/arrival/centcom)
					start_location.move_contents_to(end_location, null, NORTH)
		...
		if(1)
			...
			/* --- Shuttle leaves the station, enters transit --- */
				...
				*/
				...
				start_location = locate(/area/shuttle/escape_pod_medical/station)
				end_location = locate(/area/shuttle/escape_pod_medical/transit)
				start_location.move_contents_to(end_location, null, NORTH)
				for(var/obj/machinery/door/D in end_location)
					spawn(0)
						D.close()
				...
				start_location = locate(/area/shuttle/arrival/station)
				end_location = locate(/area/shuttle/arrival/transit)
				start_location.move_contents_to(end_location, null, EAST)
				for(var/obj/machinery/door/D in end_location)
					spawn(0)
						D.close()
				...
				world << sound('sound/AI/dockcc.ogg')
				return 1
