...
var/list/TAGGERLOCATIONS = list("Disposals",
	...
	"Robotics", "HoP Office", "Common Room", "Chapel", "The Pool",
...
//VIP Permissions
#define V_VIPDEFAULT		1
#define V_VIP				2
#define V_SUPER				4
#define V_TRANSFORM			8
...
#define CHAT_TRACK		1024
#define GHOST_INQUIS		2048

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|CHAT_OOC|CHAT_DEAD|CHAT_GHOSTEARS|CHAT_GHOSTSIGHT|CHAT_LOOC|CHAT_GHOSTRADIO)
...
#define CHAT_MSAY		2
#define CHAT_VSAY		4
#define CHAT_DEVSAY		8
#define CHAT_RADIO		16
#define CHAT_ATTACKLOGS	32
#define CHAT_DEBUGLOGS	64
#define CHAT_PRAYER		128

#define ADMIN_TOGGLES_DEFAULT (CHAT_ASAY|CHAT_MSAY|CHAT_VSAY|CHAT_RADIO|CHAT_ATTACKLOGS|CHAT_PRAYER)
