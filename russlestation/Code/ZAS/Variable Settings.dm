...
/vs_control/proc/ChangeSetting(mob/user,ch)
	...
	log_admin("\blue <b>[key_name(user)] changed the setting [display_description] to [newvar].</b>")
	message_admins("\blue <b>[key_name(user)] changed the setting [display_description] to [newvar].</b>")
	if(ch in plc.settings)
...
/vs_control/proc/SetDefault(var/mob/user)
	...
	log_admin("\blue <b>[key_name(user)] changed the global phoron/ZAS settings to \"[def]\"</b>")
	message_admins("\blue <b>[key_name(user)] changed the global phoron/ZAS settings to \"[def]\"</b>")
