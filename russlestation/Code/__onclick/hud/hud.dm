...
/datum/global_hud/New()
	...
	therm = new /obj/screen()
	therm.screen_loc = "1,1"
	therm.icon = 'icons/obj/therm_hud_full.dmi'
	therm.icon_state = "therm_hud"
	therm.layer = 17
	therm.mouse_opacity = 0
...
/datum/hud
	...
	var/obj/screen/changeling_chem_display
	var/obj/screen/ninja_cell_display
...
/datum/hud/proc/instantiate()
	...
	if(ishuman(mymob))
		...
		vampire_hud()
	else if(mymob.mind && mymob.mind.changeling)
		changeling_hud()
	else if(isninja(mymob))
		ninja_hud()
