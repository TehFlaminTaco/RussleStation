...
/datum/admins/proc/check_antagonists()
	if (ticker && ticker.current_state >= GAME_STATE_PLAYING)
		...
		if (!emergency_shuttle.online)
			...
			dat+="<a href='?src=\ref[src];call_crew_transfer=1'>Call Crew Transfer</a><br>"
		else
		...
		if(ticker.mode.Syndicateborg.len > 0)
			dat += "<br><table cellspacing=5><tr><td><B>Syndicate Assimilation Borgs</B></td><td></td><td></td></tr>"
			for(var/datum/mind/IPC in ticker.mode.Syndicateborg)
				var/mob/M = IPC.current
				if(M)
					dat += "<tr><td><a href='?src=\ref[src];adminplayeropts=\ref[M]'>[M.real_name]</a>[M.client ? "" : " <i>(logged out)</i>"][M.stat == 2 ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>"
					dat += "<td><A href='?src=\ref[usr];priv_msg=\ref[M]'>PM</A></td>"
					dat += "<td><A HREF='?src=\ref[src];traitor=\ref[M]'>Show Objective</A></td></tr>"
				else
					dat += "<tr><td><i>Syndicate Assimilation Borg not found!</i></td></tr>"
			dat += "</table>"
...
*/
		...
		if(ticker.mode.borers.len >0)
			dat += "<br><table cellspacing=5><tr><td><B>Borers</B></td><td></td><td></td></tr>"
			for(var/datum/mind/borer in ticker.mode.borers)
				var/mob/M = borer.current
				if(M)
					if(istype(M,/mob/living/simple_animal/borer))
						var/mob/living/simple_animal/borer/B = M
						dat += {"<tr><td><a href='?src=\ref[src];adminplayeropts=\ref[B]'>[B.truename]</a><br>[B.host ? "<font color =blue>host:</font><i>[B.host.real_name]<i>":""][B.controlling ? "[B.host.client ? "<i>(<font color = green>Controlling</font>)</i>" :"<i>(logged out)</i>"]" : "[B.client ? "" : " <i>(logged out)</i>"]"][B.stat == 2 ? " <b><font color=red>(DEAD)</font></b>" : ""]</td>
						<td><A href='?src=\ref[usr];priv_msg=\ref[M]'>PM</A></td>
						<td><A HREF='?src=\ref[src];traitor=\ref[M]'>Show Objective</A></td></tr>"}
					else
						dat +="<tr><td><b>ERROR non-borer in borer mind list</b></td></tr>"
				else
					dat += "<tr><td><i>Borer not found!</i></td></tr>"
			dat += "</table>"
