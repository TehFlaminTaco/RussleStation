...
/obj/item/weapon/cell/attack_self(mob/user as mob)
	...
	if(ishuman(user))
		...
		if(H.gloves)
			if(istype(H.gloves,/obj/item/clothing/gloves/space_ninja) && H.a_intent == "harm")
				var/obj/item/clothing/gloves/space_ninja/G = H.gloves
				if(!G.candrain || !G.draining)
					return
				else
					G.drain("CELL",src,H.wear_suit)
					return
