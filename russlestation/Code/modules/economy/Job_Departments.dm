...
/datum/job/dj/department = "Civilian"

/datum/job/accountant/department = "Civilian"

/datum/job/internal_affairs/department = "Civilian"
...
/datum/job/blueshield/department = "Security"
