...
/obj/item/device/eftpos/New()
	...
	spawn(0)
		...
		*/
		...
		R.info += "3. Give the EFTPOS device to your customer, he/she must finish the transaction by swiping their ID card or a electronic credit chip with enough funds.<br>"
