...
/datum/sprite_accessory/hair
	...
	bald
		...
		icon_state = "bald"
		gender = MALE
		species_allowed = list("Human","Unathi","Skrell","Vox","Aviskree", "Machine", "Diona","kidan","Avisaran")

	short
		name = "Short Hair"	  // try to capatilize the names please~
		icon_state = "hair_a" // you do not need to define _s or _l sub-states, game automatically does this for you
		species_allowed = list("Human","Aviskree","kidan")
	...
	pompadour
		...
		gender = MALE
		species_allowed = list("Human","Unathi","Aviskree","kidan")
...
/datum/sprite_accessory/facial_hair
	...
	shaved
		...
		icon_state = "bald"
		gender = NEUTER
		species_allowed = list("Human","Unathi","Tajaran","Skrell","Vox","Aviskree", "Machine", "kidan","Avisaran")
