...
/*
Just for reference, here are all of the language prefixes: ~Purlek
Sinta'Unathi - Unathi 			= :o
Rootspeak - Diona				= :q
Siik'tajr - Tajaran				= :j
Skrellian - Skrell				= :k
Aviachirp - Aviskree			= :y
Vox-Pidgin - Vox				= :v
Encoded Audio Language - IPC	= :p
Sol Common						= :1
Tradeband						= :2
Gutter							= :3
Chittin							= :4
...
And for the record, the following are the remaining chat prefixes available:
x,
z,
7,
8,
