...
/mob/living/simple_animal/tribble
	...
	var/gestation = 0
	var/maxtribbles = 20     //change this to change the max limit
	wander = 1
...
/obj/item/stack/sheet/fur/mouse //basic fur sheets (very lumpy furry piles of sheets)
	name = "pile of fur"
	desc = "The fur from mice."
	icon = 'icons/mob/tribbles.dmi'
	icon_state = "sheet-fur-m"

/obj/item/stack/sheet/fur/SA //basic fur sheets (very lumpy furry piles of sheets)
	name = "pile of fur"
	desc = "A pile of fur."
	icon = 'icons/mob/tribbles.dmi'
	icon_state = "sheet-fur-m"
