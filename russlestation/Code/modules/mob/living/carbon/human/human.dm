...
/mob/living/carbon/human/New(var/new_loc, var/new_species = null)
	...
	hud_list[THERMAL_HUD]     = image('icons/mob/hud.dmi', src, "hud_thermal")
...
/mob/living/carbon/human/proc/get_visible_name()
	...
	if( neck && (neck.flags_inv&HIDEFACE) )
		return get_id_name("Unknown")		//Likewise for hats
	if( head && (head.flags_inv&HIDEBODY) )
		return get_id_name("Unknown")
...
/mob/living/carbon/human/proc/morph()
	...
	if(new_fur)
		r_fur = hex2num(copytext(new_fur-30, 2, 4))
		g_fur = hex2num(copytext(new_fur-30, 4, 6))
		b_fur = hex2num(copytext(new_fur-30, 6, 8))
