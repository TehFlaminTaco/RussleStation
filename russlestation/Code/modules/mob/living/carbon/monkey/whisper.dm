/mob/living/carbon/monkey/whisper(var/message, var/verb = "whispers", var/datum/language/speaking = null, var/alt_name = "",var/italics = 1, var/mob/speaker = null)
	verb = pick(src.speak_emote)+" softly"
	var/style = "message"
