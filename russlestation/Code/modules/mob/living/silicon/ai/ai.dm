...
/mob/living/silicon/ai/New(loc, var/datum/ai_laws/L, var/obj/item/device/mmi/B, var/safety = 0)
	...
	if (istype(loc, /turf))
		...
		/mob/living/silicon/ai/proc/toggle_camera_light, /mob/living/silicon/ai/proc/toggle_radio_channels)
...
/mob/living/silicon/ai/verb/pick_icon()
	...
	else icontype = input("Select an icon!", "AI", null, null) in list("Monochrome", "Default", "Blue", "Inverted", "Text", "Smiley", "Angry", "Dorf", "Matrix", "Bliss", "Firewall", "Green", "Red", "Static", "Triumvirate", "Triumvirate Static")
	switch(icontype)
		if("Custom") icon_state = "[src.ckey]-ai"
		if("Default")icon_state = "ai"
...
/mob/living/silicon/ai/proc/ai_cancel_call()
	...
	if(admin_shuttle_call == 1)
		src << "The data paths to recall the shuttle have been damage beyond repair!"
		return
	if(src.stat == 2)
...
/mob/living/silicon/ai/proc/toggle_radio_channels()
	set name = "Toggle Radio channels"
	set desc = "Toggles AI Radio Channels."
	set category = "AI Commands"
	var/obj/item/device/radio/ai/R = locate() in src
	if(R)
		R.interact(usr)
