...
/mob/living/silicon/robot/proc/handle_grabber()
	if(module)
		if(module.modules)
			var/obj/item/borg/grab/BG = locate() in module.modules
			if(BG)
				if(istype(module_active, /obj/item/borg/grab))
					var/obj/item/borg/grab/D = module_active
					D.process()
					return
				else
					BG.process()
...
/mob/living/silicon/robot/proc/handle_regular_hud_updates()
	...
	if(hud)	hud.hud.process_hud(src)
