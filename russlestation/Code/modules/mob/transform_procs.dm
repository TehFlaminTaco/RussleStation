...
/mob/proc/pAItransform()
	...
	card.verbs += /obj/item/device/paicard/proc/pai_holo
...
/mob/living/carbon/human/proc/Voxify()
	if (monkeyizing)
		return
	for(var/obj/item/W in src)
		del(W)
	...
	var/mob/living/carbon/human/vox/new_vox = new /mob/living/carbon/human/vox (loc)
	...
	new_vox << "<B>You are now a Vox.</B>"
	new_vox.equipvipvox()
	new_vox.spawnedvox = 1
