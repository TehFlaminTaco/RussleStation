...
/* uncomment when gentics is fixed.
...
datum/design/SPpower
	name = "Circuit Design (Space Pod Power Control Console)"
	desc = "Allows for the construction of circuit boards used to build a space pod power control console."
	id = "sppower"
	req_tech = list("programming" = 2, "powerstorage" = 3)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP_power_console"
...
datum/design/tyrant_module
	...
	id = "tyrant_module"
	req_tech = list("programming" = 4, "syndicate" = 3, "materials" = 6)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20, "$diamond" = 100)
...
///////Space Pod Disk//////////////
///////////////////////////////////
datum/design/civ_main
	name = "Circuit Design (Civilian Space Pod Central Control module)"
	desc = "Allows for the construction of a Civilian Space Pod Central Control module."
	id = "civ_main"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/civ/main"

datum/design/civ_guid
	name = "Circuit Design (Civilian Space Pod Guidance module)"
	desc = "Allows for the construction of a Civilian Space Pod Guidance module."
	id = "civ_guid"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/civ/guidance"

datum/design/gciv_main
	name = "Circuit Design (Gold Civilian Space Pod Central Control module)"
	desc = "Allows for the construction of a Gold Civilian Space Pod Central Control module."
	id = "gciv_main"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/gciv/main"

datum/design/gciv_guid
	name = "Circuit Design (Gold Civilian Space Pod Guidance module)"
	desc = "Allows for the construction of a Gold Civilian Space Pod Guidance module."
	id = "gciv_guid"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/gciv/guidance"

datum/design/mil_main
	name = "Circuit Design (Military Space Pod Central Control module)"
	desc = "Allows for the construction of a Gold Civilian Space Pod Central Control module."
	id = "mil_main"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/mil/main"

datum/design/mil_guid
	name = "Circuit Design (Military Space Pod Guidance module)"
	desc = "Allows for the construction of a Military Space Pod Guidance module."
	id = "mil_guid"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/mil/guidance"

datum/design/indy_main
	name = "Circuit Design (Industrial Space Pod Central Control module)"
	desc = "Allows for the construction of an Industrial Space Pod Central Control module."
	id = "indy_main"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/indy/main"

datum/design/indy_guid
	name = "Circuit Design (Industrial Space Pod Guidance module)"
	desc = "Allows for the construction of a Industrial Space Pod Guidance module."
	id = "indy_guid"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/indy/guidance"

datum/design/honk_main
	name = "Circuit Design (Honk Pod Central Control module)"
	desc = "Allows for the construction of an Honk Pod Central Control module."
	id = "honk_main"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/honk/main"

datum/design/honk_guid
	name = "Circuit Design (Honk Pod Guidance module)"
	desc = "Allows for the construction of a Honk Pod Guidance module."
	id = "honk_guid"
	req_tech = list("programming" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20)
	build_path = "/obj/item/weapon/circuitboard/SP/honk/guidance"
///////////////////////////////////
//////////Mecha Module Disks///////
///////////////////////////////////
...
datum/design/clusterbang_launcher
	...
	build_type = MECHFAB
	req_tech = list("combat"= 5, "materials" = 5, "syndicate" = 5)
...
datum/design/basic_cell
	...
	id = "basic_cell"
	req_tech = list("powerstorage" = 1)
	build_type = PROTOLATHE | AUTOLATHE |MECHFAB | SPFAB
...
datum/design/super_cell
	...
	reliability_base = 75
	build_type = PROTOLATHE | MECHFAB | SPFAB
...
datum/design/SP/weapon/taser
	name = "Space Pod Weaponry System (Taser)"
	...
	category = "Weapons Upgrade"
	locked = 1

datum/design/SP/weapon/taserb
	name = "Space Pod Weaponry System (Taser Burst)"
	desc = "A weak taser system for space pods, this one fires 3 at a time."
	id = "weapon_taserb"
	req_tech = list("combat" = 4, "materials" = 5, "powerstorage" = 3)
	build_type = SPFAB
	materials = list("$metal" = 5000, "$glass" = 1000, "$uranium" = 500, "$gold" = 500)
	build_path = "/obj/item/device/spacepod_equipment/weaponry/taser/burst"
	category = "Weapons Upgrade"
	locked = 1

datum/design/SP/weapon/laser
	name = "Space Pod Weaponry System (Laser)"
	desc = "A weak laser system for space pods, fires concentrated bursts of energy"
	id = "weapon_laser"
	req_tech = list("combat" = 5, "materials" = 7, "powerstorage" = 3)
	build_type = SPFAB
	materials = list("$metal" = 5000, "$glass" = 1000, "$uranium" = 500, "$diamond" = 500, "$gold" = 500)
	build_path = "/obj/item/device/spacepod_equipment/weaponry/laser"
	category = "Weapons Upgrade"
	locked = 1

datum/design/SP/weapon/honk
	name = "Space Pod Weaponry System (Honk)"
	desc = "A Honk system for space pods, fires concentrated bursts of Honk energy."
	id = "weapon_honk"
	req_tech = list("combat" = 3, "materials" = 5, "powerstorage" = 3)
	build_type = SPFAB
	materials = list("$metal" = 5000, "$glass" = 1000, "$silver" = 500)
	build_path = "/obj/item/device/spacepod_equipment/weaponry/clown"
	category = "Weapons Upgrade"
	locked = 1
...
datum/design/borg_syndicate_module
	...
	build_type = MECHFAB
	req_tech = list("combat" = 4, "syndicate" = 5)
