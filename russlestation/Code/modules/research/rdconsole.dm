...
/obj/machinery/computer/rdconsole/attack_hand(mob/user as mob)
	...
	switch(screen)
		...
		if(3.2) //Protolathe Material Storage Sub-menu
			...
			if(linked_lathe.phoron_amount >= 2000) dat += "<A href='?src=\ref[src];lathe_ejectsheet=phoron;lathe_ejectsheet_amt=50'>(Max Sheets)</A>"
			dat += "<BR>"
			//Uranium
...
/obj/machinery/computer/rdconsole/SP
	name = "Space Pod R&D Console"
	id = 3
	req_access = null
	req_access_txt = "29"