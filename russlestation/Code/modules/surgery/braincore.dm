...
/datum/surgery_step/brain/saw_spine
	...
	end_step(mob/living/user, mob/living/carbon/human/target, target_zone, obj/item/tool)
		...
		if(target && target.species && target.species.flags & IS_SYNTHETIC)
			target << "\red your Positronic brain has been cut off from your bodies internal power supply by [user]'s [tool]."
...
/datum/surgery_step/brain/bone_chips
	...
	/obj/item/weapon/kitchen/utensil/pfork = 15)
...
/datum/surgery_step/slime/saw_core
	...
	end_step(mob/living/user, mob/living/carbon/slime/target, target_zone, obj/item/tool)
		...
		if(target.cores >= 0)
			var/obj/item/slime_extract/R =new target.coretype(target.loc)
