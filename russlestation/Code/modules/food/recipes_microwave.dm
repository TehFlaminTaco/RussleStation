...
/datum/recipe/ccandyp
	reagents = list("sugar" = 5, "oxygen" = 5)
	result = /obj/item/weapon/reagent_containers/food/snacks/ccandyp

/datum/recipe/ccandyb
	reagents = list("sugar" = 5, "nitrogen" = 5)
	result = /obj/item/weapon/reagent_containers/food/snacks/ccandyb
...
/datum/recipe/ato
	...
	result = /obj/item/weapon/reagent_containers/food/snacks/ato
