// Tajaran rigs.
/obj/item/clothing/head/helmet/space/rig/tajaran
...
/obj/item/clothing/suit/space/rig/tajaran
...
/obj/item/clothing/shoes/magboots/vox
	...
	desc = "A pair of heavy, jagged armoured foot pieces, seemingly suitable for claws."
	name = "magclaws"
	item_state = "boots-vox"
	icon_state = "boots-vox"
	digitigrade = 1   //Now for tajaran, too! ~Aztec
	baseslowdown = 1
...
// Diona rigs.
/obj/item/clothing/head/helmet/space/rig/Diona
	name = "Diona Helmet"
	desc = "A special helmet designed for work in a hazardous, low-pressure environment. Has radiation shielding. This one doesn't look like it was made for humans."
	icon_state = "rig0-diona-helmet"
	item_state = "rig0-diona-helmet"
	item_color = "diona-helmet"
	species_restricted = list("Diona")

/obj/item/clothing/suit/space/rig/Diona
	name = "Diona Hardsuit"
	desc = "A special suit that protects against hazardous, low pressure environments. Has radiation shielding. This one doesn't look like it was made for humans."
	icon_state = "rig-diona"
	item_state = "rig-diona"
	item_color = "rig-diona"
	species_restricted = list("Diona")
