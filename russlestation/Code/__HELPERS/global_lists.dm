...
var/list/vips = list()								//list of all clients whom are vips
...
var/global/list/research_list = list()
...
var/global/list/cargonav_list = list()				//list of all cargo nav beacon for mule bots.
var/global/list/all_species[0]
var/global/list/all_languages[0]
var/global/list/whitelisted_species = list("Human")
var/global/list/vipspecies = list("Human")
// Posters
...
/client/proc/is_rev()
	for(var/mob/C in player_list)
		for(var/statum/mind/D in allantags)
			if(D == C.mind)
				break
	...
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.cult)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.wizards)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.changelings)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.vampires)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.enthralled)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.syndicates)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.traitors)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.malf_ai)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.Syndicateborg)
			if(C.mind == N)
				allantags += N
	for(var/mob/C in player_list)
		for(var/datum/mind/N in ticker.mode.raiders)
			if(C.mind == N)
				allantags += N
				*/
