 ...
 **/
	...
	proc/EquipRank(var/mob/living/carbon/human/H, var/rank, var/joined_late = 0)
		...
		if(H.mind)
			...
			remembered_info += "<b>Your account funds at the start of shift were:</b> $[M.money]<br>"
		...
		if(H.mind && job.head_position)
			...
			if(department_account)
				...
				remembered_info += "<b>Your department's account funds at start of shift:</b> $[department_account.money]<br>"
		...
		if(H.job == "Bartender" || H.job == "Barkeep" || H.job == "Bar Maid" || H.job == "Chef" || H.job == "Cook" || H.job == "Botanist" || H.job == "Hydroponicist" || H.job == "Farmer" || H.job == "Horticulturalist")
			H << "<b>You have a special 'Food Services' headset to communicate with your fellow food providers, the Chef, and the Botanists. You can use this with :d.</b>"
		else if(H.job == "Captain" || H.job == "Head of Personnel" || H.job == "Human Resources Manager" || H.job == "Research Director" || H.job == "Head of Security" || H.job == "Chief Engineer" || H.job == "Chief Medical Officer")
			H << "<b>You are one of the heads of the station, Erotic Roleplay is forbidden.</b>"
