...
/var/const/access_trading = 150
/var/const/access_military = 151
/var/const/access_rep	= 152
/var/const/access_bs	= 153
/var/const/access_medgarage	= 154//Medical Garage
/var/const/access_bank= 155
/var/const/access_tardis = 160
...
/obj/proc/allowed(mob/M)
	...
	if(istype(M, /mob/living/silicon))
		...
		if(H.head)
			if(H.head.flags_inv & HIDEBODY)
				if(!src.check_access(H.get_active_hand()))
					return 0
				else
					return 1
...
/proc/get_all_accesses()
	return list(access_security, access_sec_doors, access_brig, access_armory, access_forensics_lockers, access_court,
	            ...
	            access_keycard_auth, access_tcomsat, access_gateway, access_xenoarch, access_rep, access_bs, access_military, access_trading, access_medgarage, access_bank)
...
/proc/get_region_accesses(var/code)
	switch(code)
		...
		if(2) //medbay
			return list(access_medical, access_genetics, access_morgue, access_chemistry, access_psychiatrist, access_virology, access_surgery, access_cmo, access_medgarage)
		if(3) //research
		...
		if(6) //station general
			return list(access_kitchen,access_bar, access_hydroponics, access_janitor, access_chapel_office, access_crematorium, access_library, access_theatre, access_lawyer, access_clown, access_mime, access_bank)
		if(7) //supply
