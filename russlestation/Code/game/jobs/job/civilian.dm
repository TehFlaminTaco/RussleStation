...
/datum/job/bartender
	...
	alt_titles = list("Barkeep","Bar Maid",)
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/device/radio/headset/headset_ser(H), slot_l_ear)
...
/datum/job/hydro
	...
	alt_titles = list("Hydroponicist","Farmer","Horticulturalist")
...
//		H.equip_to_slot_or_del(new /obj/item/clothing/gloves/black(H), slot_gloves)
		if(H.backbag == 1)
			...
			H.equip_to_slot_or_del(new /obj/item/device/mining_scanner(H), slot_in_backpack)
			if(H.client.vipholder && H.client.vipholder.rights & V_SUPER)
				H.equip_to_slot_or_del(new /obj/item/VIP_store(H.back), slot_in_backpack)
		return 1
...
/datum/job/janitor
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/belt/janitor/full(H), slot_belt)
		if(H.backbag == 1)
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H), slot_r_hand)
		else
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H.back), slot_in_backpack)
...
/datum/job/accountant
	...
	alt_titles = list("Bank Clerk","Finance Controller",)


	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_to_slot_or_del(new /obj/item/clothing/under/suit_jacket/red(H), slot_w_uniform)
		H.equip_to_slot_or_del(new /obj/item/device/pda/accountant(H), slot_wear_pda)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(H), slot_shoes)
		if(H.backbag == 1)
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H), slot_r_hand)
		else
