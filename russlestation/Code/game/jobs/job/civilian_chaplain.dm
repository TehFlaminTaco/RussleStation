...
/datum/job/chaplain
	...
	alt_titles = list("Counselor","Priest","Rabbi","Pastor","Minister","Nun")
	var/religion = ""
	...
	equip(var/mob/living/carbon/human/H)
		...
		spawn(1)
			...
			var/bibletypes = list("Bible", "Koran", "Scrapbook", "Creeper", "White Bible", "Holy Light", "Athiest", "Tome", "The King in Yellow", "Ithaqua", "Scientology", "the bible melts", "Necronomicon")
			if(religion == "cheezeanity")
				bibletypes += "Pizza"
			while(!accepted)
				if(!B) break // prevents possible runtime errors
				new_book_style = input(H,"Which bible style would you like?") in bibletypes
