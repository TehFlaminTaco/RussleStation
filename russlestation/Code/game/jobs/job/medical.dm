/datum/job/cmo
	...
	access = list(access_medical, access_morgue, access_genetics, access_heads,
			...
			access_keycard_auth, access_sec_doors, access_psychiatrist, access_medgarage)
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.backbag == 1)
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/glasses/hud/health(H.back), slot_in_backpack)
			if(H.client.vipholder && H.client.vipholder.rights & V_SUPER)
...
/datum/job/EMT
	...
	selection_color = "#ffeef0"
	idtype = /obj/item/weapon/card/id/med
	alt_titles = list("Paramedic","Emergency Medical Technician", "Emergency Physician")
	access = list(access_medical, access_morgue, access_surgery, access_chemistry, access_virology, access_genetics, access_medgarage)
	minimal_access = list(access_medical, access_morgue, access_surgery, access_virology, access_medgarage)
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/key/ambulance(H), slot_r_store)
		H.equip_to_slot_or_del(new /obj/item/clothing/shoes/white(H), slot_shoes)
		H.equip_to_slot_or_del(new /obj/item/device/pda/medical(H), slot_wear_pda)
		H.equip_to_slot_or_del(new /obj/item/weapon/storage/firstaid/adv(H), slot_l_hand)
		H.equip_to_slot_or_del(new /obj/item/device/flashlight/pen(H), slot_s_store)
...
/datum/job/geneticist
	...
	supervisors = "the chief medical officer"
	selection_color = "#ffeef0"
	alt_titles = list("DNA Analyst", "Biological Engineer")
	idtype = /obj/item/weapon/card/id/med
	...
	equip(var/mob/living/carbon/human/H)
		...
		if(H.backbag == 1)
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H), slot_r_hand)
			if(H.client.vipholder && H.client.vipholder.rights & V_SUPER)
				H.equip_to_slot_or_del(new /obj/item/VIP_store(H.back), slot_l_hand)
		else
			H.equip_to_slot_or_del(new /obj/item/weapon/storage/box/survival(H.back), slot_in_backpack)
			if(H.client.vipholder && H.client.vipholder.rights & V_SUPER)
				H.equip_to_slot_or_del(new /obj/item/VIP_store(H.back), slot_in_backpack)
