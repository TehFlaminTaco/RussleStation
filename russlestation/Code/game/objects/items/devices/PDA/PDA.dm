...
/obj/item/device/pda/botanist
	...
	icon_state = "pda-botanist"

/obj/item/device/pda/roboticist
	icon_state = "pda-roboticist"

/obj/item/device/pda/librarian
	icon_state = "pda-librarian"
...
/obj/item/device/pda/chemist
	...
	icon_state = "pda-chemist"

/obj/item/device/pda/geneticist
	default_cartridge = /obj/item/weapon/cartridge/medical
	icon_state = "pda-geneticist"

/obj/item/device/pda/accountant
	icon_state = "pda-accountant"
...
/obj/item/device/pda/proc/detonate_act(var/obj/item/device/pda/P)
	...
	if(i<=15) //The traditional explosion
		P.explode()
		j=1
		message += "Your [P] suddenly explodes!"
	if(i>=15 && i<= 25) //The PDA burns a hole in the holder.
		j=1
		if(M && isliving(M))
