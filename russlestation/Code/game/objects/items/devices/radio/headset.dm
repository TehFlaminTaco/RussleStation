...
/obj/item/device/radio/headset/headset_ser
	name = "food service headset"
	desc = "This is used by those who supply food and drink to the masses. To access the food channel, use :d."
	icon_state = "headset"
	item_state = "headset"
	keyslot2 = new /obj/item/device/encryptionkey/headset_ser
