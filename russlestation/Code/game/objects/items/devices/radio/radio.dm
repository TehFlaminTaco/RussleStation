	...
	if(GLOBAL_RADIO_TYPE == 1) // NEW RADIO SYSTEMS: By Doohl
	  ...
	  /* ###### Intercoms and station-bounced radios ###### */
		...
		for (var/mob/R in receive)
			if (R.client)
				continue
			if (R.client.holder && !(R.client.prefs.Atoggles & CHAT_RADIO)) //Adminning with 80 people on can be fun when you're trying to talk and all you can hear is radios.
				return
