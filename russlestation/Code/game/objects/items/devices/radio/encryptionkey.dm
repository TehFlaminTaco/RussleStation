...
/obj/item/device/encryptionkey/headset_ser
	name = "Food Services Encryption Key"
...
/obj/item/device/encryptionkey/heads/hop
	...
	channels = list("Supply" = 1, "Command" = 1, "Security" = 0, "Service" = 0)
/*
...
/obj/item/device/encryptionkey/ert
	...
	desc = "An encyption key for a radio headset.  Contains cypherkeys."
	channels = list("Response Team" = 1, "Science" = 1, "Command" = 1, "Medical" = 1, "Engineering" = 1, "Security" = 1, "Supply" = 1, "Service" = 0)
