...
*/
		...
		randomItems.Add("obj/item/toy/cards/deck/syndicate")//syndicate Playing cards
	...
	if(!randomItems.len)
		...
		switch(buyItem) //Ok, this gets a little messy, sorry.
			...
			"/obj/item/weapon/storage/box/syndie_kit/imp_freedom" , "/obj/item/clothing/glasses/thermal/syndi")
				uses -= 3
			if("/obj/item/ammo_magazine/a357" , "/obj/item/clothing/shoes/syndigaloshes" , "/obj/item/weapon/plastique", "/obj/item/weapon/card/id/syndicate", "obj/item/toy/cards/deck/syndicate")
				uses -= 2
...
//For stat tracking, sorry for making it so ugly
	...
	switch(boughtItem)
		...
		if("obj/item/toy/cards/deck/syndicate")
			feedback_add_details("traitor_uplink_items_bought","SC")
