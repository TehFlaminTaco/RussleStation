...
/obj/item/weapon/extinguisher/afterattack(atom/target, mob/user , flag)
	...
	if( istype(target, /obj/structure/reagent_dispensers/watertank) && get_dist(src,target) <= 1)
		...
		return
	if (istype(target, /obj/item/weapon/reagent_containers/glass/chemtank) && get_dist(src,target) <= 1)
		var/obj/item/weapon/reagent_containers/glass/chemtank/o = target
		if(!o.fillup)
