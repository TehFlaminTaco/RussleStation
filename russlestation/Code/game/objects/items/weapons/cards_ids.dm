...
/obj/item/weapon/card/id/captains_spare
	...
	New()
		...
		access = J.get_access()
		..()
/obj/item/weapon/card/id/TL
	name = "an old yale key"
	desc = "This key belonged to the Time Lord himself."
	icon = 'icons/obj/custom_items.dmi'
	icon_state = "keygold"
	registered_name = "The Doctor"
	assignment = "Time Lord"
	New()
		access =list(access_tardis)
		..()
...
/obj/item/weapon/card/emag/screwdriver
	desc = "It's a screwdriver with an cryptographic sequencer built in. Doesn't look like it will funtion as a screwdriver though..."
	name = "sonic screwdriver"
	icon = 'icons/obj/items.dmi'
	icon_state = "screwdriver_emag"
	item_state = "screwdriver_brown"
	origin_tech = "magnets=2;syndicate=2;materials=1;engineering=1"
	uses = 15

/obj/item/weapon/card/emag_broken/screwdriver
	desc = "It's a screwdriver with an cryptographic sequencer built in. It looks too busted to be used for anything but salvage."
	name = "broken sonic screwdriver"
	icon = 'icons/obj/items.dmi'
	icon_state = "screwdriver_emag_broken"
	item_state = "screwdriver_brown"
	origin_tech = "magnets=2;syndicate=2;materials=1;engineering=1"

/obj/item/weapon/card/emag/screwdriver/afterattack(var/obj/item/weapon/O as obj, mob/user as mob)
	...
	if(uses<1)
		user.visible_message("[src] fizzles and sparks - it seems it's been used once too often, and is now broken.")
		user.drop_item()
		var/obj/item/weapon/card/emag_broken/screwdriver/junk = new(user.loc)
		junk.pickup(user)
		junk.add_fingerprint(user)
		user.put_in_active_hand(junk)
		del(src)
