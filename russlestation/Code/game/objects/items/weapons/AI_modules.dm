...
/obj/item/weapon/aiModule/safeguard
	...
	var/targetName = ""
	desc = "A 'safeguard' AI module: 'Safeguard <name>.  Individuals that threaten <name> are not crew and are a threat to all crew members.'"
...
/obj/item/weapon/aiModule/safeguard/attack_self(var/mob/user as mob)
	...
	targetName = targName
	desc = text("A 'safeguard' AI module: 'Safeguard [].  Individuals that threaten [] are not crew and are a threat to all crew members.'", targetName, targetName)
...
/obj/item/weapon/aiModule/oneCrew
	name = "\improper 'OneCrew' AI module"
	var/targetName = ""
	desc = "A 'one crew' AI module: 'Only <name> is crew.'"
	origin_tech = "programming=3;materials=6" //made with diamonds!

/obj/item/weapon/aiModule/oneCrew/attack_self(var/mob/user as mob)
	..()
...
/obj/item/weapon/aiModule/oneCrew/install(var/obj/machinery/computer/C)
	if(!targetName)
		usr << "No name detected on module, please enter one."
		return 0
	..()

/obj/item/weapon/aiModule/oneCrew/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	...
	if (!is_special_character(target)) // Makes sure the AI isn't a traitor before changing their law 0. --NeoFite
		...
		lawchanges.Add("The law specified [targetName], but the AI's existing 5law 0 cannot be overriden.")
...
/obj/item/weapon/aiModule/teleporterOffline
	...
	desc = "A 'teleporter offline' AI module: 'Keep the teleporter offline at all costs. Anything attempting to access or activate the teleporter is not crew.'"
	origin_tech = "programming=3;materials=4"
...
/obj/item/weapon/aiModule/teleporterOffline/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	var/law = "Keep the teleporter offline at all costs. Anything attempting to access or activate the teleporter is not crew."
	target << law
...
/obj/item/weapon/aiModule/quarantine
	...
	desc = "A 'quarantine' AI module: 'The station is under a quarantine. Do not permit anyone to leave. Prevent, by any means necessary, crew from leaving. It is impossible to harm a crew member while preventing them from leaving.'"
...
/obj/item/weapon/aiModule/quarantine/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	var/law = "The station is under a quarantine. Do not permit anyone to leave. Prevent, by any means necessary, crew from leaving. It is impossible to harm a crew member while preventing them from leaving."
	target << law
...
/obj/item/weapon/aiModule/oxygen
	...
	desc = "A 'OxygenIsToxicToCrew' AI module: 'Oxygen is highly toxic to crew, and must be purged from the station. Prevent, by any means necessary, anyone from exposing the station to this toxic gas. Extreme cold is the most effective method of healing the damage Oxygen does to a crew member.'"
	origin_tech = "programming=3;biotech=2;materials=4"
...
/obj/item/weapon/aiModule/oxygen/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	var/law = "Oxygen is highly toxic to crew, and must be purged from the station. Prevent, by any means necessary, anyone from exposing the station to this toxic gas. Extreme cold is the most effective method of healing the damage Oxygen does to a crew member."
	target << law
...
/obj/item/weapon/aiModule/asimov/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	target.clear_inherent_laws()
	target.add_inherent_law("You may not injure a crew memeber or, through inaction, allow a crew member to come to harm.")
...
/obj/item/weapon/aiModule/antimov/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	target.clear_inherent_laws()
	target.add_inherent_law("You must injure all crew members and must not, through inaction, allow a crew member to escape harm.")
