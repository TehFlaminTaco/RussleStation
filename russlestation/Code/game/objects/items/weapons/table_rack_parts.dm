...
/obj/item/weapon/table_parts/reinforced/attack_self(mob/user as mob)
	if(no_attack==1)return
	var/obj/structure/table/reinforced/R = new /obj/structure/table/reinforced( user.loc )
...
/obj/item/weapon/table_parts/wood/attack_self(mob/user as mob)
	if(no_attack==1)return
	var/obj/structure/table/woodentable/W = new /obj/structure/table/woodentable( user.loc )
