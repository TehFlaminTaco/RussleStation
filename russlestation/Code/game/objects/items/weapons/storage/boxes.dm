...
/obj/item/weapon/storage/box/wallet
	name = "box of wallets"
	desc = "Contains Wallets."
	storage_slots=21
	can_hold = list("/obj/item/weapon/storage/wallet")
...
/obj/item/weapon/storage/box/chemimp
	name = "boxedchemical implant kit"
...
/obj/item/weapon/storage/box/lights/emergency/New()
	..()
	for(var/i = 0; i < 21; i++)
		new /obj/item/weapon/light/emergency(src)
...
//Encryption key boxes, because CARGO!
/obj/item/weapon/storage/box/enckey_eng
	name = "box of engineering encryption keys"
	desc = "Contains encryption keys."
	New()
		..()
...
/obj/item/weapon/storage/box/enckey_med
	name = "box of medical encryption keys"
	desc = "Contains encryption keys."
	New()
		..()
...
/obj/item/weapon/storage/box/enckey_sup
	name = "box of supply encryption keys"
	desc = "Contains encryption keys."
	New()
		..()
...
/obj/item/weapon/storage/box/enckey_sci
	name = "box of science encryption keys"
	desc = "Contains encryption keys."
	New()
		..()
...
/obj/item/weapon/storage/box/enckey_sec
	name = "box of security encryption keys"
	desc = "Contains encryption keys."
	New()
		..()
		new /obj/item/device/encryptionkey/headset_sec(src)
		new /obj/item/device/encryptionkey/headset_sec(src)
		new /obj/item/device/encryptionkey/headset_sec(src)
		new /obj/item/device/encryptionkey/headset_sec(src)

/obj/item/weapon/storage/box/enckey_ser
	name = "box of food service encryption keys"
	desc = "Contains encryption keys."
	New()
		..()
		new /obj/item/device/encryptionkey/headset_ser(src)
		new /obj/item/device/encryptionkey/headset_ser(src)
		new /obj/item/device/encryptionkey/headset_ser(src)
		new /obj/item/device/encryptionkey/headset_ser(src)