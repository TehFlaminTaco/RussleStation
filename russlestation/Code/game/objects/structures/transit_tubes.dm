...
/obj/structure/transit_tube_pod/New(loc)
	...
	air_contents.oxygen = O2STANDARD*air_contents.volume/(R_IDEAL_GAS_EQUATION*air_contents.temperature)
	air_contents.nitrogen = N2STANDARD*air_contents.volume/(R_IDEAL_GAS_EQUATION*air_contents.temperature)
