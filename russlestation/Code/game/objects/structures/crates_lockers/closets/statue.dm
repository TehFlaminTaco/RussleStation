/obj/structure/closet/statue
	...
	var/intialBrute = 0
	var/intialOxy = 0
	var/timer = 8 //eventually the person will be freed
...
/obj/structure/closet/statue/New(loc, var/mob/living/L)
	...
	if(ishuman(L) || ismonkey(L) || iscorgi(L))
		...
		health = L.health + 500 //stoning damaged mobs will result in easier to shatter statues
...
/obj/structure/closet/statue/attack_animal(mob/living/simple_animal/user as mob)
	if(user.client)
		health -=user.harm_intent_damage
		visible_message("\red <b>[src]</b> has been attacked by [user]!","\red<b>You slashes at \the [src]!")
