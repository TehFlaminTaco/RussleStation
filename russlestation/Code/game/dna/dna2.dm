...
/datum/dna/proc/ResetUIFrom(var/mob/living/carbon/human/character)
	...
	SetUIValueRange(DNA_UI_SKIN_R,    character.r_fur,    255,    1)
	SetUIValueRange(DNA_UI_SKIN_G,    character.g_fur,    255,    1)
	SetUIValueRange(DNA_UI_SKIN_B,    character.b_fur,    255,    1)
