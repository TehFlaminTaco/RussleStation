/turf/simulated/wall
	...
	density = 1
	blocks_air = 1
	var/DT = 1200 //wallrot destroytime
...
/turf/simulated/wall/proc/rot()
	if(!rotting)
		...
		for(var/i=0, i<number_rots, i++)
			...
			O.layer = 5
			O.mouse_opacity = 0
/turf/simulated/wall/proc/rotDel()
	sleep(DT)
	if(rotting)
