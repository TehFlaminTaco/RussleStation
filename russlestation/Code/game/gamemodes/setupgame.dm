...
/proc/setupgenetics()
	...
	*/
	...
	//NOBREATHBLOCK      = getAssignedBlock("NOBREATH",      numsToAssign, DNA_HARD_BOUNDS) //Doesn't even have code? ~Aztec
	...
	//MORPHBLOCK         = getAssignedBlock("MORPH",         numsToAssign, DNA_HARDER_BOUNDS) //This is broke. ~Aztec
...
//Comment any of those out to turn it off ~Aztec
