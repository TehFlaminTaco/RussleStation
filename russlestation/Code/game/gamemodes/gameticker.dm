...
/datum/controller/gameticker/proc/pregame()
	...
	while (!setup())
/datum/controller/gameticker/proc/c_login_music()
	login_music = pick(\
	...
	'sound/music/SSOS13.ogg',
	'sound/music/SSOS113.ogg',
	'sound/music/SS13CT.ogg')
...
/datum/controller/gameticker/proc/setup()
	...
	if (!src.mode.can_start())
		message_admins("<B>Unable to start [mode.name].</B> Not enough players, [mode.required_players] players needed. Reverting to pre-game lobby.")
		del(mode)
		current_state = GAME_STATE_PREGAME
		job_master.ResetOccupations()
		return 0
