...
/datum/game_mode/heist/proc/greet_vox(var/datum/mind/raider)
	...
	raider.current << "\blue The Vox are a race of cunning, sharp-eyed nomadic raiders and traders endemic to Tau Ceti and much of the unexplored galaxy. You and the crew have come to the Horizon for plunder, trade or both."
	...
	raider.current << "\blue Use :V to voxtalk, :H to talk on your encrypted channel, :W to use your internal radio link, and don't forget to turn on your nitrogen internals!"
