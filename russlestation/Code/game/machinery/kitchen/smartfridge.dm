...
/obj/machinery/smartfridge/drinks/accept_check(var/obj/item/O as obj)
	if(istype(O,/obj/item/weapon/reagent_containers/food/drinks/bottle))
		return 0
...
/obj/machinery/smartfridge/attack_ai(mob/user as mob) //Now Borgs can use these, too! ~Aztec
	if(!ispowered) return
	ui_interact(user)
