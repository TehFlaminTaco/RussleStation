...
/obj/item/weapon/circuitboard/SP_power_console
	name = "Circuit board (Space Pod Power Control Console)"
	build_path = "/obj/machinery/computer/SP_power_console"
	origin_tech = "programming=2;powerstorage=3"
...
/obj/item/weapon/circuitboard/rdconsole/attackby(obj/item/I as obj, mob/user as mob)
	if(istype(I,/obj/item/weapon/screwdriver))
		...
		else if(src.build_path == "/obj/machinery/computer/rdconsole/robotics")
			src.name = "Circuit Board (RD Console - Space Pod)"
			src.build_path = "/obj/machinery/computer/rdconsole/SP"
			user << "\blue Access protocols set to space pod."
		else
