...
/obj/machinery/computer/card/attack_hand(var/mob/user as mob)
	...
	if (mode) // accessing crew manifest
		...
		var/jobs_all = ""
		var/counter = 0
		jobs_all += "<table align='center' style='width:100%'>"
		jobs_all += "<tr align='center'><td><b><u>Special</u></b></font></tr></td></table><table align='center' style='width:100%'><tr align='center'>"//Captain in special because he is head of heads ~Intercross21
		jobs_all += "<td><a href='?src=\ref[src];choice=assign;assign_target=Captain'>Captain</a></td>"
		jobs_all += "<td><a href='?src=\ref[src];choice=assign;assign_target=Custom'>Custom</a></td>"
		jobs_all += "</tr></table><hr><table align='center' style='width:100%'><tr align='center'>"

		counter = 0
		jobs_all += "</tr><tr align='center'><td style='width:14%'><font color='#800000'><b><u>Security</u></b></font></td></tr></table><table align='center' style='width:100%'><tr align='center'>"//red
		for(var/job in security_positions)
			counter++
			if(counter >= 6)
				jobs_all += "</tr><tr align='center'>"
				counter = 0
			jobs_all += "<td style='width:14%'><a href='?src=\ref[src];choice=assign;assign_target=[job]'>[replacetext(job, " ", "&nbsp")]</a></td>"
		jobs_all += "</table><hr><table align='center' style='width:100%'>"

		counter = 0
		jobs_all += "</tr><tr align='center'><td style='width:14%'><font color='#FFA500'><b><u>Engineering</u></b></font></td></tr></table><table align='center' style='width:100%'><tr align='center'>"//Orange
		...
		counter = 0
		jobs_all += "</tr><tr align='center'><td style='width:14%'><font color='#008000'><b><u>Medical</u></b></font></td></tr></table><table align='center' style='width:100%'><tr align='center'>"//Green
		...
		counter = 0
		jobs_all += "</tr><tr align='center'><td style='width:14%'><font color='#800080'><b><u>Science</u></b></font></td></tr></table><table align='center' style='width:100%'><tr align='center'>"//Purple
		...
		counter = 0
		jobs_all += "</tr><tr align='center'><td style='width:14%'><font color='#808080'><b><u>Civilian</u></b></font></td></tr></table><table align='center' style='width:100%'><tr align='center'>"//Grey
		...
		if(istype(src,/obj/machinery/computer/card/centcom))
			counter = 0
			jobs_all += "</tr><tr align='center'><td style='width:14%'><font color='#A52A2A'><b><u>CentComm</u></b></font></td></tr></table><table align='center' style='width:100%'><tr align='center'>"//Brown
			for(var/job in get_all_centcom_jobs())
				if(counter >= 6)
					jobs_all += "</tr><tr>"
					counter = 0
				jobs_all += "<td style='width:14%'><a href='?src=\ref[src];choice=assign;assign_target=[job]'>[replacetext(job, " ", "&nbsp")]</a></td>"
			jobs_all += "</table><hr><table>"
