  ...
  /* ###### Organize the receivers into categories for displaying the message ###### */
	...
	for (var/mob/R in receive)
	  ...
	  /* --- Loop through the receivers and categorize them --- */
		...
		if (R.client && !(R.client.prefs.Atoggles & CHAT_RADIO)) //Adminning with 80 people on can be fun when you're trying to talk and all you can hear is radios.
			continue
