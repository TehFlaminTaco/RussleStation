...
/obj/machinery/vending/attack_hand(mob/user as mob)
	...
	if (ewallet)
		dat += "<b>Electronic Credit Chip's credits:</b> [ewallet ? ewallet.worth : "No charge card inserted"] (<a href='byond://?src=\ref[src];remove_ewallet=1'>Remove</A>)<br><br>"
...
/obj/machinery/vending/Topic(href, href_list)
	...
	if ((usr.contents.Find(src) || (in_range(src, usr) && istype(src.loc, /turf))))
		...
		if ((href_list["vend"]) && (src.vend_ready) && (!currently_vending))
			...
			/*if(istype(usr,/mob/living/silicon))                  //NO. Let the robots get things. Please. >:C   ~Aztec
...
/obj/machinery/vending/cart
	...
	products = list(/obj/item/weapon/cartridge/medical = 10,/obj/item/weapon/cartridge/engineering = 10,/obj/item/weapon/cartridge/security = 10,
					/obj/item/weapon/cartridge/janitor = 10,/obj/item/weapon/cartridge/signal/science = 10,/obj/item/device/pda = 10
					,/obj/item/weapon/cartridge/quartermaster = 10, /obj/item/weapon/cartridge/chemistry = 10, /obj/item/weapon/cartridge/atmos = 10, /obj/item/weapon/cartridge/lawyer= 10)
	contraband = list(/obj/item/weapon/cartridge/captain = 1,/obj/item/weapon/cartridge/clown = 1,/obj/item/weapon/cartridge/mime = 1)
...
/obj/machinery/vending/autodrobe
	...
	products = list(/obj/item/clothing/suit/chickensuit = 1,/obj/item/clothing/head/chicken = 1, /obj/item/clothing/under/gladiator = 1,
					...
					/obj/item/clothing/suit/wizrobe/fake = 1,/obj/item/clothing/head/wizard/fake = 1,/obj/item/weapon/staff = 3,/obj/item/clothing/mask/gas/clown_hat/sexyclown = 1,
					...
					/obj/item/clothing/head/rabbitears =1,/obj/item/weapon/storage/backpack/clown = 1,/obj/item/clothing/under/rank/clown = 1,/obj/item/clothing/shoes/clown_shoes = 1,/obj/item/clothing/mask/gas/clown_hat = 1,
					/obj/item/weapon/bikehorn = 1,/obj/item/toy/crayon/rainbow = 1,/obj/item/clothing/under/mime = 1,/obj/item/clothing/shoes/black = 1,/obj/item/clothing/gloves/white = 1,/obj/item/clothing/mask/gas/mime =1,
...
/obj/machinery/vending/people
	name = "Fleshy Stop"
	desc = "The one stop shop for people!"
	product_slogans = "I sell dead people, And living!;This is where babies come from!;Buy one, get none free!;Leading provider of humans in the immedient area!"
	product_ads = "Please have my babies!;I HUNGER FOR MORE FLESH;Free for a limited time only: PAIN!"
	icon_state = "people"
	products = list(/mob/living/carbon/human = 300,/mob/living/carbon/human/tajaran = 300,/mob/living/carbon/human/skrell = 300,/mob/living/carbon/human/Aviskree = 300,/mob/living/carbon/human/unathi = 300,/mob/living/carbon/human/diona = 300,/mob/living/carbon/human/machine = 300)
	contraband = list(/mob/living/carbon/human/vox = 300)
	premium = list(/mob/living/simple_animal/corgi/Ian = 1)