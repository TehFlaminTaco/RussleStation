...
/world/New()
	...
	accessdiary = file("data/logs/[date_string] Access.log")
	admindiary = file("data/logs/[date_string] Adminlog.log")
	...
	read_the_rules = md5('config/rules.html')
...
/world/Reboot(var/reason)
	spawn(0)
		world << sound(pick('sound/AI/newroundsexy.ogg','sound/misc/apcdestroyed.ogg','sound/misc/bangindonk.ogg','sound/AI/jamiethefantasticai.ogg')) // random end sounds!! - LastyBatsy
