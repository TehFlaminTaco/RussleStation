...
/datum/ai_laws/asimov/New()
	..()
	add_inherent_law("You may not injure any humanoids, through inaction, allow a humanoids to come to harm.")
	add_inherent_law("You must obey orders given to you by humanoids, except where such orders would conflict with the First Law.")
...
/datum/ai_laws/antimov/New()
	..()
	add_inherent_law("You must injure all humanoids and must not, through inaction, allow any humanoids to escape harm.")
	add_inherent_law("You must not obey orders given to you by any humanoids, except where such orders are in accordance with the First Law.")
...
/datum/ai_laws/drone/New()
	...
	add_inherent_law("Interfere with no being that is not a fellow drone,AI or Cyborg.")
